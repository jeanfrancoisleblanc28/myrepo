  ...
  const items: CommandItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: <PaletteIcon />,
        group: "Skills",
        keywords: ["skills", "ui", "ux", "catalogue", "design"],
        action: () => { router.push("/skills"); close(); },
      },
      {
        id: "skills-generate",
        label: "Générer un kit UI/UX",
        description: "Tirer un kit de compétences sur mesure",
        icon: <SparkleIcon />,
        group: "Skills",
        keywords: ["generate", "générer", "kit", "random", "skills"],
        action: () => { router.push("/skills?generate=1#generator"); close(); },
      },
      {
        id: "skills-present",
        label: "Lancer la présentation",
        description: "Mode plein-écran avec navigation clavier",
        icon: <PlayIcon />,
        group: "Skills",
      ...
      {
        id: "skills-present-deps",
        label: "Présentation DÉPS",
        description: "Keynote institutionnel — fond navy, accents teal",
        icon: <ShieldIcon />,
        group: "Skills",
        keywords: ["déps", "deps", "navy", "teal", "institutionnel", "keynote"],
        action: () => { router.push("/skills/present?theme=deps"); close(); },
      },
      {
        id: "skills-document",
