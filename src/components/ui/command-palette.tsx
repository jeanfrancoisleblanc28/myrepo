...
export function CommandPalette() {
  ...
  const items: CommandItem[] = useMemo(
    () => [
      ...
      {
        id: "skills-compare",
        label: "Comparer des compétences",
        description: "Afficher 2 à 3 compétences côte à côte",
        icon: <CompareIcon />,
        group: "Skills",
        keywords: ["comparer", "compare", "versus", "vs", "côte"],
        action: () => { router.push("/skills/compare"); close(); },
      },
      {
        id: "theme-toggle",
